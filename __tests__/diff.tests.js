...
const testPath1 = getFixturePath('file10.json');
const testPath2 = getFixturePath('file20.json');

// const expectString = readFileSync(getFixturePath('expected.txt'), 'utf8');

const expectString = readFileSync(getFixturePath('expected2.txt'), 'utf8');

test('testing function plain gendiff(filepath1, filepath2)', () => {
  expect(gendiff(testPath1, testPath2)).toBe(expectString);
});
